...
class ActiveXY:
    ...
    # ## Infinite T
    # def kuramoto_force_inf_T(self, lattice):
    #     return self.kuramoto_dV(lattice)

    # def andy_force_inf_T(self, lattice):
    #     return self.andy_dV1(lattice) + self.andy_dV3(lattice)

    # def marvin_force_inf_T(self, lattice):
    #     return self.marvin_dV(lattice)

    # def eli_force_inf_T(self, lattice):
    #     return self.eli_dV(lattice)

    # ## Open
    # def open_kuramoto_force(self, lattice):
    #     return self.open_kuramoto_dV(lattice) + self.open_kuramoto_muV(lattice) / self.temp

    # def open_andy_force(self, lattice):
    #     return self.open_andy_dV1(lattice) + self.open_andy_dV3(lattice) + self.open_andy_muV(lattice) / self.temp

    # def open_marvin_force(self, lattice):
    #     return self.open_marvin_dV(lattice) + self.open_marvin_muV(lattice) / self.temp

    # def open_eli_force(self, lattice):
    #     return self.open_eli_dV(lattice) + self.open_eli_muV(lattice) / self.temp
